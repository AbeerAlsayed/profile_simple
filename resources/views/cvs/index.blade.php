		...
		<div class="container">
			...
			<div class="section started">
				<div class="st-box">
					...
					<div class="st-image"><img src="#" alt="" /></div>
				...
				<div class="section works" id="works-section">
					...
					<div class="row box-items">
						<div class="col col-m-12 col-t-6 col-d-4 box-item f-mockup animated">
							<div class="image">
								<a href="#popup-1" class="has-popup"><img src='#' alt="" /></a>
							</div>
							<div class="content-box">
						...
						<div class="col col-m-12 col-t-6 col-d-4 box-item f-graphic animated">
							<div class="image">
								<a href="#popup-2" class="has-popup"><img src='#' alt="" /></a>
							</div>
							<div class="content-box">
						...
						<div class="col col-m-12 col-t-6 col-d-4 box-item f-mockup animated">
							<div class="image">
								<a href="#popup-3" class="has-popup"><img src="#" alt="" /></a>
							</div>
							<div class="content-box">
								<div class="category">Mockups</div>
						...
						<div class="col col-m-12 col-t-6 col-d-4 box-item f-icons animated">
							<div class="image">
								<a href="#popup-4" class="has-popup"><img src="#" alt="" /></a>
							</div>
							<div class="content-box">
						...
						<div class="col col-m-12 col-t-6 col-d-4 box-item f-ui animated">
							<div class="image">
								<a href="#popup-5" class="has-popup"><img src="#" alt="" /></a>
							</div>
							<div class="content-box">
						...
						<div class="col col-m-12 col-t-6 col-d-4 box-item f-ui animated">
							<div class="image">
								<a href="#popup-6" class="has-popup"><img src="#" alt="" /></a>
							</div>
							<div class="content-box">
								<div class="category">UI Kits</div>
					...
					<div class="row">
						<div class="col col-m-12 col-t-6 col-d-6">
							<div class="blog_item animated">
								<div class="image">
									<a href="blog-page.html"><img src="#"alt="" /></a>
								</div>
								<div class="content-box">
									<div class="i_title">
